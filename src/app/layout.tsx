 ...
 * Implements the GOV.UK Design System template structure.
 *
...
import { GovukClientInit } from "@/components/GovukClientInit";
...
export const metadata: Metadata = {
  title: {
    template: "%s - GOV.UK",
    default: "GOV.UK Next.js Starter",
  },
  description:
    "A Next.js starter project for building GOV.UK Design System compliant websites",
};
 ...
 * Provides the GOV.UK template structure including header, footer, and skip link.
 */
    ...
    <html lang="en" className="govuk-template">
      ...
      <body className="govuk-template__body">
            ...
            <div className="govuk-header__logo">
              ...
              >
                <span className="govuk-header__logotype">
                  ...
                  >
                    <g>
                      <circle cx="20" cy="17.6" r="3.7" fill="currentColor" />
                      <circle cx="10.2" cy="23.5" r="3.7" fill="currentColor" />
                      <circle cx="3.7" cy="33.2" r="3.7" fill="currentColor" />
                      <circle cx="31.7" cy="30.6" r="3.7" fill="currentColor" />
                      <circle cx="43.3" cy="17.6" r="3.7" fill="currentColor" />
                      <circle cx="53.2" cy="23.5" r="3.7" fill="currentColor" />
                      <circle cx="59.7" cy="33.2" r="3.7" fill="currentColor" />
                      <circle cx="31.7" cy="30.6" r="3.7" fill="currentColor" />
                      <path
                        fill="currentColor"
        ...
        <div className="govuk-width-container">
          {/* Phase banner (optional - remove if not in beta) */}
